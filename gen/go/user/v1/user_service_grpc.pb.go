...
type UserServiceClient interface {
	...
	GetMyProfile(ctx context.Context, in *GetMyProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error)
	Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*v1.Empty, error)
	Unsubscribe(ctx context.Context, in *UnsubscribeRequest, opts ...grpc.CallOption) (*v1.Empty, error)
...
func (c *userServiceClient) GetMyProfile(ctx context.Context, in *GetMyProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*v1.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Empty)
...
func (c *userServiceClient) Unsubscribe(ctx context.Context, in *UnsubscribeRequest, opts ...grpc.CallOption) (*v1.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Empty)
...
type UserServiceServer interface {
	...
	Subscribe(context.Context, *SubscribeRequest) (*v1.Empty, error)
	Unsubscribe(context.Context, *UnsubscribeRequest) (*v1.Empty, error)
...
func (UnimplementedUserServiceServer) GetMyProfile(context.Context, *GetMyProfileRequest) (*ProfileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMyProfile not implemented")
}
func (UnimplementedUserServiceServer) Subscribe(context.Context, *SubscribeRequest) (*v1.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Subscribe not implemented")
}
func (UnimplementedUserServiceServer) Unsubscribe(context.Context, *UnsubscribeRequest) (*v1.Empty, error) {
